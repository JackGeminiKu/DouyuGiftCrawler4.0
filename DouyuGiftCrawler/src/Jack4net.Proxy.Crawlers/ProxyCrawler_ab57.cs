...
{
    public class ProxyCrawler_ab57 : ProxyCrawlerBase
    {
        public ProxyCrawler_ab57()
        {
            Urls.Add("http://ab57.ru/downloads/proxyold.txt");
        }
        ...
        protected override void ParseWebPage(string webPage, string url)
        {
            ...
            foreach (var item in proxyList) {
                ...
                OnProxyCrawled(proxyInfo[0], proxyInfo[1].ConvertTo<int>(), "ab57.ru");
            }
        }
    }
}
